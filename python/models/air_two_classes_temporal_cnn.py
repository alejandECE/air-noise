...
class AirBinaryTemporalCNN:
  ...
  def summary(self) -> None:
    ...
    tf.keras.utils.plot_model(self.model,
                              to_file=save_path + 'air_two_classes_temporal_cnn.jpg',
  ...
  def train(self, epochs):
    ...
    save_path = self.experiments_folder + 'trained_model/air_two_classes_temporal_cnn/'
...
if __name__ == '__main__':
  ...
  learner = AirBinaryTemporalCNN(folder, use_batch_norm=True)
  learner.summary()
  learner.train(200)
  # It loads the saved model (potentially better than the one after last epoch)
  saved_model = tf.keras.models.load_model(learner.experiments_folder + 'trained_model/air_two_classes_temporal_cnn/')
